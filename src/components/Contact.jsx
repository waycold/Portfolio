  ...
  return (
    <section id="contact" className="section-container py-20 md:py-28">
      <div className="max-w-3xl mx-auto text-center bg-charcoal-850 border border-border-color rounded-lg p-8 sm:p-12 shadow-xl shadow-black/30">
        ...
        <div className="max-w-md mx-auto mb-6 p-4 rounded-md bg-charcoal-900/90 border border-border-color/80 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-inner">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded bg-azure-500/10 text-azure-400 flex items-center justify-center">
            ...
            <a 
              href={`mailto:${email}`} 
              className="text-sm sm:text-base font-semibold text-white hover:text-azure-400 transition-colors"
            >
              {email}
            </a>
          </div>
          ...
          <button
            ...
            className="text-xs font-medium px-3 py-1.5 rounded bg-charcoal-800 hover:bg-charcoal-700 text-slate-200 hover:text-white transition-all cursor-pointer flex items-center gap-1.5"
        ...
        <div className="flex justify-center items-center gap-4">
          <a 
            ...
            className="inline-flex items-center gap-2 text-sm font-semibold text-charcoal-300 hover:text-azure-400 transition-colors px-4 py-2"
          >
